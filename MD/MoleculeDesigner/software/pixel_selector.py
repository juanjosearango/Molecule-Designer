# pixel_selector is an external code shared by Sam Murphy under Apache License 2.0 (https://www.apache.org/licenses/LICENSE-2.0)
# https://github.com/samsammurphy/pixel_selector
# © 2017 Sam Murphy

#NOTICE: Very slight modifications were carried out in the lines of this code signaled with a commented mark ('# MODIFIED LINE!')
...
class Selector:
  ...
  def image_handler(self):
    ...
    def red_dot(event,x,y,flags,param):
      if event == cv2.EVENT_LBUTTONUP:
        ...
        cv2.circle(img,(x,y),6,(255,255,255),-1) # MODIFIED LINE!
        cv2.circle(img,(x,y),5,(0,0,255),-1) # MODIFIED LINE!
  ...
  def run(self):
    ...
    print('\n✓ coords file already created from image.\n') # MODIFIED LINE!
